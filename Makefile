...
# LESS and CSS
LESS 		 	= style.less base.less default.less light.less color.less dark.less colorful.less typography.less balance.less depth.less unity.less photo.less texture.less gradient.less
...
# target: upgrade-grid - Upgrade grid modules - Grid structure
.PHONY: upgrade-grid
upgrade-grid:
	@$(call HELPTEXT,$@)
